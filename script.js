    url='https://d3yowc8vr7.execute-api.us-east-1.amazonaws.com/Predict/3554dfdc-1753-4702-a305-91f7be5ac42b'
    messages={"FLAT":"Yay!! You landed safely!!",
              "NOTFLAT":"Sorry!! The lander crashed!!!"}
    predictionCount=0
      
    function drawMain() {
      var canvas = document.getElementById('mainCanvas');
      var img = document.getElementById("marsImage");
    ...
    function drawSecond(x,y) {
      ...
      var img2 = document.getElementById("marsImage");
